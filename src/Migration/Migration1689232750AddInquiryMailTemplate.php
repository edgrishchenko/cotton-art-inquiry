...
class Migration1689232750AddInquiryMailTemplate extends MigrationStep
{
    ...
    private function getContentHtmlEn(): string
    {
        return <<<MAIL
            ...
            <p>
                ...
                {% if order.customFields.custom_cottonartinquiry_method_type %}
                    <strong>Finishing method type: </strong>
                    {% for methodType in order.customFields.custom_cottonartinquiry_method_type %}
                        {% if methodType %}
                            {{ methodType }}
                ...
                {% if order.customFields.custom_cottonartinquiry_logo_placement %}
                    <strong>Logo placement: </strong>
                    {% for logoPlace in order.customFields.custom_cottonartinquiry_logo_placement %}
                        {% if logoPlace %}
                            {{ logoPlace }}
                ...
                {% if order.customFields.custom_cottonartinquiry_logo_color %}
                    <strong>Logo color: </strong>{{ order.customFields.custom_cottonartinquiry_logo_color }}
                    <br>
                {% endif %}
                
                {% if order.customFields.custom_cottonartinquiry_delivery_duration %}
                    <strong>Delivery method type: </strong>
                    {% for methodType in order.customFields.custom_cottonartinquiry_delivery_duration %}
                        {% if methodType %}
                            {{ methodType }}
                ...
                {% if order.customFields.custom_cottonartinquiry_comment %}
                    <strong>Comment: </strong>{{ order.customFields.custom_cottonartinquiry_comment }}
                    <br>
                {% endif %}
    ...
    private function getContentPlainEn(): string
    {
        return <<<MAIL
            ...
            {% if order.customFields.custom_cottonartinquiry_logo_color %}
            Logo color: {{ order.customFields.custom_cottonartinquiry_logo_color }}
            {% endif %}
            ...
            {% if order.customFields.custom_cottonartinquiry_comment %}
                Comment: {{ order.customFields.custom_cottonartinquiry_comment }}
            {% endif %}
    ...
    private function getContentHtmlDe(): string
    {
        return <<<MAIL
            ...
            <p>
                ...
                {% if order.customFields.custom_cottonartinquiry_method_type %}
                    <strong>Typ der Endbearbeitungsmethode: </strong>
                    {% for methodType in order.customFields.custom_cottonartinquiry_method_type %}
                        {% if methodType %}
                            {{ methodType }}
                ...
                {% if order.customFields.custom_cottonartinquiry_logo_placement %}
                    <strong>Logo-Platzierung: </strong>
                    {% for logoPlace in order.customFields.custom_cottonartinquiry_logo_placement %}
                        {% if logoPlace %}
                            {{ logoPlace }}
                ...
                {% if order.customFields.custom_cottonartinquiry_logo_color %}
                    <strong>Logofarbe: </strong>{{ order.customFields.custom_cottonartinquiry_logo_color }}
                    <br>
                {% endif %}
                
                {% if order.customFields.custom_cottonartinquiry_delivery_duration %}
                    <strong>Lieferdauer: </strong>
                    {% for methodType in order.customFields.custom_cottonartinquiry_delivery_duration %}
                        {% if methodType %}
                            {{ methodType }}
                ...
                {% if order.customFields.custom_cottonartinquiry_comment %}
                    <strong>Kommentar: </strong>{{ order.customFields.custom_cottonartinquiry_comment }}
                    <br>
                {% endif %}
    ...
    private function getContentPlainDe(): string
    {
        return <<<MAIL
            ...
            {% if order.customFields.custom_cottonartinquiry_method_type %}
                Typ der Endbearbeitungsmethode: 
                {% for methodType in order.customFields.custom_cottonartinquiry_method_type %}
                    {% if methodType %}
                        {{ methodType }}
            ...
            {% if order.customFields.custom_cottonartinquiry_logo_color %}
            Logofarbe: {{ order.customFields.custom_cottonartinquiry_logo_color }}
            {% endif %}
            ...
            {% if order.customFields.custom_cottonartinquiry_comment %}
                Kommentar: {{ order.customFields.custom_cottonartinquiry_comment }}
            {% endif %}
